...
--#5:
ALTER TYPE ENUM_VEHICLES_FUELTYPE RENAME VALUE 'Benzin' TO 'BENZIN';
ALTER TYPE ENUM_VEHICLES_FUELTYPE RENAME VALUE 'Diesel' TO 'DIESEL';
ALTER TYPE ENUM_VEHICLES_FUELTYPE RENAME VALUE 'Strom' TO 'STROM';
ALTER TYPE ENUM_VEHICLES_FUELTYPE RENAME VALUE 'Erdgas' TO 'ERDGAS';

--#6:
ALTER TYPE ENUM_TRIP_TYPE RENAME VALUE 'geschäftlich' TO 'GESCHÄFTLICH';
ALTER TYPE ENUM_TRIP_TYPE RENAME VALUE 'privat' TO 'PRIVAT';