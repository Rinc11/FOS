...
INSERT INTO fos."Vehicles" ("Serialnumber", "Brand", "Type", "BuildYear", "FuelType") VALUES (1234-312-32, 'Ford', 'Focus', 2010, 'Benzin');
INSERT INTO fos."Vehicles" ("Serialnumber", "Brand", "Type", "BuildYear", "FuelType") VALUES (1234-12-43, 'Fiat', 'Panda', 2011, 'Benzin');
INSERT INTO fos."Vehicles" ("Serialnumber", "Brand", "Type", "BuildYear", "FuelType") VALUES (1234-234-21, 'VW', 'Golf', 2014, 'Benzin');
INSERT INTO fos."Vehicles" ("Serialnumber", "Brand", "Type", "BuildYear", "FuelType") VALUES (1234-123-23, 'BMW', 'X3', 2006, 'Diesel');
INSERT INTO fos."Vehicles" ("Serialnumber", "Brand", "Type", "BuildYear", "FuelType") VALUES (1234-123-65, 'Ford', 'Fiesta', 2004, 'Erdgas');
INSERT INTO fos."Vehicles" ("Serialnumber", "Brand", "Type", "BuildYear", "FuelType") VALUES (1234-123-54, 'OPEL', 'Astra', 2014, 'Benzin');

-- INSERT TRIP

INSERT INTO fos."Trip" ("VehicleID", "StartTime", "EndTime", "PlaceStart", "PlaceEnd", "Start_km", "End_km", "Type", "Username") VALUES (1, '2018-03-08 13:04:03.614000', '2018-03-09 13:04:10.340000', 'Frauenfeld', 'Winterthur', 100, 130, 'privat', 'suttema2');
INSERT INTO fos."Trip" ("VehicleID", "StartTime", "EndTime", "PlaceStart", "PlaceEnd", "Start_km", "End_km", "Type", "Username") VALUES (2, '2018-03-08 13:04:03.614000', '2018-03-09 13:04:10.340000', 'Frauenfeld', 'Winterthur', 100, 130, 'geschäftlich', 'wipffab');
INSERT INTO fos."Trip" ("VehicleID", "StartTime", "EndTime", "PlaceStart", "PlaceEnd", "Start_km", "End_km", "Type", "Username") VALUES (3, '2018-03-08 13:04:03.614000', '2018-03-09 13:04:10.340000', 'Frauenfeld', 'Winterthur', 100, 130, 'privat', 'mayerret');